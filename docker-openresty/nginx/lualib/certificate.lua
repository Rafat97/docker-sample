local certificates = require "lib.certificates"
local ssl = require "ngx.ssl"
local redis = require "redis"
local utils = require "utils"

local disable_lets_encrypt = false
...
if host_certificates ~= nil then
    ...
    ngx.log(ngx.ERR, "Invalid SSL certificate")


    if not disable_lets_encrypt then
        ngx.log(ngx.ERR, "Invalid SSL certificate 2")
